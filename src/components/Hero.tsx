  ...
  return (
    <section id="home" className="relative full-screen-section min-h-[600px] md:min-h-[700px] flex flex-col justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src="/images/vibrant_luxury_real_estate_1779647538138.png"
          alt="Modern Luxury Real Estate"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[rgba(15,35,20,0.85)] via-[rgba(15,35,20,0.5)] to-transparent" />
      </div>
